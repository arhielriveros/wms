...
Schema y tablas: `integration.inbox, integration.outbox, integration.delivery_attempt`.
...
Retención: entidades operativas según política; auditoría/movimientos son append-only. TEST-INT-0004 prueba RLS y permisos de schema.
