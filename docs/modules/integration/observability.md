...
Métricas: lag, reintentos, DLQ, duplicados y entrega exitosa; tasa de errores por código, reintentos, DLQ y duración de transacción. Trazas marcan espera de DB/broker y llamadas externas.
