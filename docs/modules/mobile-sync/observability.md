...
Métricas: sync p95, conflictos, backlog y comandos duplicados; tasa de errores por código, reintentos, DLQ y duración de transacción. Trazas marcan espera de DB/broker y llamadas externas.
