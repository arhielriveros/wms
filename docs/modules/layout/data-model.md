...
Schema y tablas: `layout.warehouse, layout.zone, layout.location`.
...
Retención: entidades operativas según política; auditoría/movimientos son append-only. TEST-LAY-0004 prueba RLS y permisos de schema.
