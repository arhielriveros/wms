...
Métricas: ubicaciones activas, bloqueadas y errores de escaneo; tasa de errores por código, reintentos, DLQ y duración de transacción. Trazas marcan espera de DB/broker y llamadas externas.
