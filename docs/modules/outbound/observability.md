...
Métricas: order cycle time, fill rate, short picks y despacho; tasa de errores por código, reintentos, DLQ y duración de transacción. Trazas marcan espera de DB/broker y llamadas externas.
