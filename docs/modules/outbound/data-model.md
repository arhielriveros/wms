# Modelo de datos — Outbound

Schema y tablas: `outbound.sales_order, outbound.order_line, outbound.shipment`.
...
Retención: entidades operativas según política; auditoría/movimientos son append-only. TEST-OUT-0004 prueba RLS y permisos de schema.
