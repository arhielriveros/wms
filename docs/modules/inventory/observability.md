...
Métricas: exactitud, conflictos, stock negativo y latencia de bloqueo; tasa de errores por código, reintentos, DLQ y duración de transacción. Trazas marcan espera de DB/broker y llamadas externas.
