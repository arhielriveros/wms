# Observabilidad — Seguridad y Auditoría
...
Métricas: denegaciones, latencia de autorización y cobertura de auditoría; tasa de errores por código, reintentos, DLQ y duración de transacción. Trazas marcan espera de DB/broker y llamadas externas.
