# Modelo de datos — Seguridad y Auditoría

Schema y tablas: `security.audit_entry, security.access_decision`.
...
Retención: entidades operativas según política; auditoría/movimientos son append-only. TEST-SEC-0004 prueba RLS y permisos de schema.
