# Modelo de datos — Inbound

Schema y tablas: `inbound.asn, inbound.asn_line, inbound.receipt`.
...
Retención: entidades operativas según política; auditoría/movimientos son append-only. TEST-INB-0004 prueba RLS y permisos de schema.
