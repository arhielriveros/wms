...
Schema y tablas: `master_data.sku, master_data.barcode`.
...
Retención: entidades operativas según política; auditoría/movimientos son append-only. TEST-MST-0004 prueba RLS y permisos de schema.
