...
Métricas: SKUs activos, barcodes ambiguos y rechazos de importación; tasa de errores por código, reintentos, DLQ y duración de transacción. Trazas marcan espera de DB/broker y llamadas externas.
