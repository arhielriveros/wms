# Modelo de datos — Plataforma

Schema y tablas: `platform.request_context, platform.feature_flag, platform.outbox`.
...
Retención: entidades operativas según política; auditoría/movimientos son append-only. TEST-PLT-0004 prueba RLS y permisos de schema.
