...
Métricas: p95 de middleware y disponibilidad; tasa de errores por código, reintentos, DLQ y duración de transacción. Trazas marcan espera de DB/broker y llamadas externas.
