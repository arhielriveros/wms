...
Métricas: cero accesos cruzados y resolución p95; tasa de errores por código, reintentos, DLQ y duración de transacción. Trazas marcan espera de DB/broker y llamadas externas.
