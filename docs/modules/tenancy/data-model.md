# Modelo de datos — Tenancy

Schema y tablas: `tenancy.tenant, tenancy.tenant_scope`.
...
Retención: entidades operativas según política; auditoría/movimientos son append-only. TEST-TEN-0004 prueba RLS y permisos de schema.
