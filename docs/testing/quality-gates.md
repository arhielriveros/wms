...
Rendimiento/SLO, seguridad, restore, Zebra, WCAG, UAT, runbooks, dashboards, release notes y shadow mode aprobados. Cero defectos críticos; altos requieren aceptación documentada y fecha.
